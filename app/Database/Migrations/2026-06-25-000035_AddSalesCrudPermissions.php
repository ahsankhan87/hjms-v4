...
class AddSalesCrudPermissions extends Migration
{
    public function up()
    {
        ...
        $permissionRows = $this->db->table('permissions')->select('id')->whereIn('name', ['sales.view', 'sales.manage', 'sales.create', 'sales.edit', 'sales.delete'])->get()->getResultArray();
