...
class MainCompanyController extends BaseController
{
    public function index(): string
    {
        ...
        return view('portal/main_company/index', [
    ...
    public function update()
    {
        ...
        if (! $this->validateData($payload, [
            ...
            return redirect()->to('/main-company')->withInput()->with('errors', $this->validator->getErrors());
        }
        ...
        try {
            ...
            return redirect()->to('/main-company')->with('success', 'Main company updated successfully.');
        } catch (\Throwable $e) {
            return redirect()->to('/main-company')->withInput()->with('error', $e->getMessage());
        }
    }
