...
<main class="min-h-screen flex items-center justify-center p-6">
    <div class="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow-xl shadow-slate-200/60">
        ...
        <form method="post" action="<?= site_url('/app/forgot-password') ?>" class="mt-6 space-y-4">
            <?= csrf_field() ?>
            <div>
            ...
            <button type="submit" class="btn btn-md btn-primary btn-block">Generate Reset Link</button>
        </form>
